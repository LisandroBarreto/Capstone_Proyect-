...
def analyze_sentiment_bert(text):
    ...
    muypo_keywords = ["muy bien", "muy feliz", "muy contenta", "muy contento",
                    "muy correcta", "muy correcto", "excelente", "genial", "muy buen humor"]
    muynp_keywords = ["muy mal", "muy triste", "muy enojada", "muy enojado", "horrible",
                    "desastroso", "desastrosa", "muy mal humor"]
    ...
    # LÓGICA DE NEUTRAL (AHORA CON LA LÓGICA DE REFUERZO COMPLETA DENTRO)
        ...
        basic_po_keywords = ["bien", "contenta", "contento", "feliz", 
                            "correcta", "correcto", "alegre", "optimista",
                            "agusto", "comoda", "comodo", "aceptable", "satisfactorio",
                            "satisfactoria", "bueno", "buena", "tranquila", "tranquilo",
                            "relajada", "relajado", "mejor", "gusto", "agradable", "placer"]
        # Palabras clave de Negativo Básico
        basic_ne_keywords = ["mal", "triste", "enojada", "enojado", "molesta", "molesto", "preocupada",
                            "preocupado", "decepcionada", "decepcionado", "desanimada", "desanimado",
                            "pesimo", "pesima", "terrible", "desacuerdo", "fallo", "malo", "mala",
                            "incorrecta", "incorrecto", "estresada", "estresado", "agotada", "agotado", 
                            "cansada", "cansado", "peor", "problema", "duda", "inestable", "riesgo"]
